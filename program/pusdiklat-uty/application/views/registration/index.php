            ...
            <div class="col-md-8">
                <form id="msform" action="<?= base_url('registration/addmember') ?>" method="post">
                    ...
                    <fieldset style="transform: scale(1);  opacity: 1; display: block;" class="tab">
                        ...
                        <input type="number" name="no_identitas" class="form-control" placeholder="No Identitas" required>
                    ...
                    <fieldset class="tab">
                        ...
                        <input type="email" id="email" onblur="CekEmail()" class="form-control" name="email" placeholder="Email">
