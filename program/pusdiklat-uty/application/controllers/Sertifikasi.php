...
class Sertifikasi extends CI_Controller
{
    ...
    public function kartu_ujian($id)
    {
        ...
        $query = "SELECT peserta.`id`, akun_user.`nama`,akun_user.`no_identitas`, akun_user.`foto_profil`, akun_user.`tgl_lahir`, kelas.`nama_ruangan`,kelas.`lokasi`, kelas.`tanggal_ujian`, jenis_ujian.* , jenis_sertifikasi.*
		FROM peserta, akun_user, kelas, boking_kelas, jenis_ujian, jenis_sertifikasi
